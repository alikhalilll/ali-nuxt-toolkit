...
4. [Caching](#caching)
   ...
   - [Forcing a refetch](#forcing-a-refetch)
   - [Custom cache keys](#custom-cache-keys)
   - [Manual invalidation after mutations](#manual-invalidation-after-mutations)
   - [Disabling the cache](#disabling-the-cache)
   - [SSR → CSR hydration](#ssr--csr-hydration)
   - [`CacheOptions` reference](#cacheoptions-reference)
   - [`CacheConfig` reference](#cacheconfig-reference)
...
8. [`RequestOptions` reference](#requestoptions-reference)
9. [`RetryOptions` reference](#retryoptions-reference)
10. [Exported types](#exported-types)
