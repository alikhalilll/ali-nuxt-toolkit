...
| `forceBottomSheet` | `boolean`                      | `false`              | Force the drawer (bottom-sheet) branch regardless of viewport width — desktops render the vaul drawer too. Bypasses `breakpoint`.               |
